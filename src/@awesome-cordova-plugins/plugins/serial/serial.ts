...
export class Serial extends IonicNativePlugin {
   ...
   *
   * @param options {SerialPermissionOptions} Options used to request serial
   *     permissions for an unknown device
   * @return {Promise<any>} Returns a promise that resolves when permissions are
   *     granted
   */
   ...
   * @return {Promise<any>} Returns a promise that resolves when the serial
   ...
   * @return {Promise<any>} Returns a promise that resolves when the write is
   *     complete
   */
  @Cordova()
   ...
   *
   * @return {Promise<any>} Returns a promise that resolves with data read from
  ...
  /**
   * Watch the incoming data from the serial connection. Clear the watch by
   * unsubscribing from the observable
   *
   * @returns {Observable<any>} Observable returns an observable that you can
   *     subscribe to
   */
